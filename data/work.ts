const work: Array<Experience> = [
	...
	},
	{
		...
		points: [
			`This exhibition was a series of building sized projections along the streets of Toronto; viewers could approach a box housing a Raspberry Pi (RPi) to interact with the piece in realtime.`,
